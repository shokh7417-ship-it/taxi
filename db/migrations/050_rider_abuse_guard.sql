...
CREATE TABLE rider_abuse_events (
...
CREATE INDEX idx_rider_abuse_events_rider_created_at
    ON rider_abuse_events (rider_user_id, created_at);

CREATE TABLE rider_abuse_state (
...
-- +goose Down
DROP TABLE IF EXISTS rider_abuse_state;
DROP TABLE IF EXISTS rider_abuse_events;
